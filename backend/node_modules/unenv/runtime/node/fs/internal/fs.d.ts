...
export declare const glob: typeof fs.glob;
export declare const appendFileSync: any;
...
export declare const copyFileSync: any;
export declare const cpSync: any;
...
export declare const fdatasyncSync: any;
...
export declare const lutimesSync: any;
...
export declare const rmdirSync: any;
...
export declare const writevSync: any;
export declare const statfsSync: typeof fs.statfsSync;
export declare const globSync: any;
