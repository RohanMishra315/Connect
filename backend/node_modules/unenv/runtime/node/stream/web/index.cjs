...
const DecompressionStream = exports.DecompressionStream = globalThis.DecompressionStream || (0, _utils.notImplemented)("stream.web.DecompressionStream");
const CompressionStream = exports.CompressionStream = globalThis.DecompressionStream || (0, _utils.notImplemented)("stream.web.CompressionStream");
module.exports = {
  ReadableStream,
