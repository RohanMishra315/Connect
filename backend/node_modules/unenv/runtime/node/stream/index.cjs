...
var _readable = require("./internal/readable.cjs");
var _writable = require("./internal/writable.cjs");
var _duplex = require("./internal/duplex.cjs");
var _transform = require("./internal/transform.cjs");
